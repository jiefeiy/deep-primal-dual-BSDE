...
def get_args():
    ...
    parser.add_argument('--valid_size', default=2 ** 19, type=int, help="number of samples for lower bound")
    parser.add_argument('--upper_size', default=2 ** 12, type=int, help="number of samples for upper bound")
    ...
    parser.add_argument('--d', default=3, type=int, help="dimension of stochastic variables")
